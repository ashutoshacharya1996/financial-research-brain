# Opportunity Record — defence-electronics-aerospace-2026-Q4
...
- **QRSAM ₹30,000cr — BEL share confirmed and signing imminent:** Contract value confirmed at ₹30,000cr; BEL identified as ~70% system integrator (~₹21,000cr); BDL ~30% (~₹9,000cr); July 2026 signing expected; delivery commences ~18 months post-signing (~Jan 2028); order book lifts ~40% on signing day — single near-term binary catalyst; per Catalyst Update — BEL — 2026-06-21
...
- **QRSAM timing slippage:** QRSAM has already slipped from February/March 2026 → July 2026 — Indian defence procurement delays are structural; one more quarter delay would push BEL revenue recognition well into FY28 and defer the ~40% order book lift
...
| HAL | MALE UAV Tender Event — 10 bidders, bids closed | 2026-06-16 |
| LT | MALE UAV Tender Event — bid submitted | 2026-06-16 |
| BEL | Catalyst Update — QRSAM ₹30,000cr confirmed; BEL ~70% share | 2026-06-21 |
| HAL | Earnings Update — FY26 PAT ₹9,115.52cr (27.6% net margin) confirmed | 2026-06-21 |

---

## Corroboration Count
4 companies | 2 runs — BEL, HAL, LT, PARAS

---

## Contradictory Evidence
**Required at 8.3/10 (>8.0 threshold):**

- **QRSAM procurement delay pattern:** QRSAM signing already slipped once from February/March 2026 to July 2026. Indian defence procurement has a documented history of multi-quarter delays at contract signing stage; "expected July 2026" is not a committed date. A further slip pushes BEL's ~40% order book event and FY28 revenue recognition deeper into the future. Source: Catalyst Update — BEL — 2026-06-21.
...
- **10-way competition limits MALE UAV win probability:** With 10 qualified bidders and a split-order (L1 + L2 winning ~₹15,000cr each), the expected value for any individual company is materially lower than the ₹30,000cr headline. If HAL and LT both bid, the joint probability of the thesis playing out (both win) is not high; one winning and one losing is the base case. Source: MALE UAV Tender Event — 2026-06-16.
- **LT Q4 FY26 execution quality:** LT's Q4 FY26 PAT came in at -3% YoY (₹5,326cr) with EBITDA margin 10.4% — the largest capex EPC player in the tracked universe showed margin compression even as order books hit record levels. This is a direct counter-signal to the premise that order book wins convert cleanly to profit. Source: Earnings Update — LT — 2026-06-21.
